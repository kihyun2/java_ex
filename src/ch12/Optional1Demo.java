...
public class Optional1Demo {
	public static void main(String[] args) {
		...
		i1.ifPresentOrElse(System.out::println, () -> System.out.println("0으로 나눌 수 없습니다."));
		Optional<String> s = Optional.ofNullable("apple");
		Optional<String> s1 = Optional.ofNullable(null);

		System.out.println(s.get());
		System.out.println(s1);
		s.ifPresentOrElse(str -> System.out.println(str), () -> System.out.println("빈문자열입니다."));
		s1.ifPresentOrElse(str -> System.out.println(str), () -> System.out.println("빈문자열입니다."));
	}
